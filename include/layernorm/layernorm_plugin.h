#ifndef TENSORRT_CUSTOM_PLUGINS_LAYERNORM_PLUGIN_H
#define TENSORRT_CUSTOM_PLUGINS_LAYERNORM_PLUGIN_H
...
class LayerNormPlugin : public nvinfer1::IPluginV3,
                        public nvinfer1::IPluginV3OneCore,
                        public nvinfer1::IPluginV3OneBuild,
                        public nvinfer1::IPluginV3OneRuntime
{
public:
    explicit LayerNormPlugin(float eps);
...
private:
    ...
    nvinfer1::PluginField mFields[1];
};

class LayerNormPluginCreator : public nvinfer1::IPluginCreatorV3One
{
public:
